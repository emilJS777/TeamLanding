...
onMounted(() => {
  ...
  document.title = 'DENeon Team — Product Development Team'
  document.querySelector('meta[name="description"]')?.setAttribute('content', 'DENeon Team — product development across backend, web, mobile, QA and blockchain.')
  const canonical = document.querySelector('link[rel="canonical"]')
  if (canonical) canonical.href = 'https://team.deneon.net/'
})
onBeforeUnmount(() => {
  ...
  <div class="site-shell">
    <header class="header">
      ...
      <nav :class="['nav', { 'nav--open': mobileMenuOpen }]" aria-label="Main navigation">
        ...
        <RouterLink class="nav-project-link" to="/start-project" @click="mobileMenuOpen = false">Start a project</RouterLink>
      </nav>
...
<!--        </div>-->
      ...
      <section id="contact" class="contact-section">
        ...
        <h2>Let’s talk.</h2>
        <p>Have a project in mind or simply want to get in touch? Tell us what you need and we’ll direct your message to the right people.</p>
        <div class="contact-actions">
          <RouterLink class="button button--primary" to="/start-project">Start a project <span>→</span></RouterLink>
          <RouterLink class="button button--outline" to="/contact">Contact us <span>→</span></RouterLink>
        </div>
      </section>
    </main>
